...
interface ISetResultsForCup {
    ...
    void withoutLosserAndCheck(Button firstPlayer, String firstPlayerString, Button secundPlayer, String secundPlayerString, Button ResultButton, EditText pointsFor1In1Set, EditText pointsFor1In2Set, EditText pointsFor1In3Set, EditText pointsFor2In1Set, EditText pointsFor2In2Set, EditText pointsFor2In3Set);
