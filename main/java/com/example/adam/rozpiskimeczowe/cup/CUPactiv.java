package com.example.adam.rozpiskimeczowe.cup;
...
public class CUPactiv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cupactiv);
        ...
        final EditText editTextPkt = findViewById(R.id.cupEditTextPkt);
        final RelativeLayout relativeLayout = findViewById(R.id.cupMainLayout);
        ...
        final RadioButton radioButton8 = findViewById(R.id.cupRadioButton8);
        final RadioButton radioButton16 = findViewById(R.id.cupRadioButton16);
        final RadioButton radioButton24 = findViewById(R.id.cupRadioButton24);
                ...
                if(quantityOfTeam!=0) {
                    ...
                    if(checkNull) {
                        ...
                        switch (quantityOfTeam) {
                            ...
                            case 8:intent = new Intent(CUPactiv.this, CUPactiv32.class);
                            case 16:intent = new Intent(CUPactiv.this, CUPactiv32.class);
                            case 24:intent = new Intent(CUPactiv.this, CUPactiv32.class);
                        }
